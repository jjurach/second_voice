...
**Note:** Cline is an interactive development tool (like Claude Code, Aider), not an LLM provider. See `docs/system-prompts/tools/cline.md` for how to use Cline with AGENTS.md workflow.
